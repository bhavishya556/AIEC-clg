          ...
          <div className="footer-content">
            <div className="footer-content-column">
              <div className="footer-logo">
                <a className="footer-logo-link" href="/">
                  <span className="hidden-link-text">LOGO
                  </span>
                  <h1>AI <h2>Experience Centre</h2></h1>
                </a>
              </div>
              <div className="footer-menu">
                ...
                <ul id="menu-get-started" className="footer-menu-list">
                  <li className="menu-item menu-item-type-post_type menu-item-object-product">
                    <a href="https://iitmjanakpuri.com/">Start</a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="footer-menu">
                ...
                <ul id="menu-company" className="footer-menu-list">
                  <li className="menu-item menu-item-type-post_type menu-item-object-page">
                    <a href="https://iitmjanakpuri.com/">Contact</a>
                  </li>
                  <li className="menu-item menu-item-type-taxonomy menu-item-object-category">
                    <a href="https://iitmjanakpuri.com/">News</a>
                  </li>
                  <li className="menu-item menu-item-type-post_type menu-item-object-page">
                    <a href="https://iitmjanakpuri.com/">Careers</a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="footer-menu">
                ...
                <ul id="menu-quick-links" className="footer-menu-list">
                  <li className="menu-item menu-item-type-custom menu-item-object-custom">
                    <a target="_blank" rel="noopener noreferrer" href="https://iitmjanakpuri.com/">Support Center</a>
                  </li>
                  <li className="menu-item menu-item-type-custom menu-item-object-custom">
                    <a target="_blank" rel="noopener noreferrer" href="https://iitmjanakpuri.com/aboutus_new/iqac1.php">IQAC</a>
                  </li>
                  <li className="menu-item menu-item-type-post_type menu-item-object-page">
                    <a href="https://iitmjanakpuri.com/">Security</a>
                  </li>
                  <li className="menu-item menu-item-type-post_type menu-item-object-page">
                    <a href="https://iitmjanakpuri.com/upload_new/csii.pdf">Computer Society of India</a>
                  </li>
                  <li className="menu-item menu-item-type-post_type menu-item-object-page">
                    <a href="https://iitmjanakpuri.com/">Reviews</a>
                  </li>
                </ul>
              </div>
            </div>
            <div className="footer-content-column">
              <div className="footer-call-to-action">
                ...
                <a className="footer-call-to-action-button button" href="mailto:a.i.experiencecenter.iitm@gmail.com" target="_self"> Get in Touch </a>
              </div>
              <div className="footer-call-to-action">
                <h2 className="footer-call-to-action-title"> You Call Us</h2>
                <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="tel:9911410841" target="_self"> 9911410841 </a></p>
              </div>
            </div>
          ...
          <div className="footer-copyright">
            <div className="footer-copyright-wrapper">
              <p className="footer-copyright-text">
                <span className="footer-copyright-link"> ©2023. | Designed & Developed By: <a href='https://github.com/harsh0519'> Harsh Kumar Mehta </a>& <a href='https://github.com/goyalnikhil179'> Nikhil Goyal </a>| All rights reserved. </span>
              </p>
            </div>
          </div>
        </footer>
